<?php
  $cardsPerRow = get_field('home_cs_cards_per_row');
  $eyebrowHeading = get_field('home_cs_eyebrow_heading');
  $sectionTitle = get_field('home_cs_section_title');
...
<section class="home-cards-section">
  <div class="container">
    ...
    <div class="cards-wrp row">
      <?php if(have_rows('home_cs_content')): ?>
        <?php while ( have_rows('home_cs_content') )  : the_row(); ?>
          <?php
