<?php
  ...
  $sectionEyebrowHeading = get_sub_field('fcp_tcs_section_eyebrow_heading');
  $sectionHeading = get_sub_field('fcp_tcs_section_heading');
...
<section class="fcp-section two-column-section <?php echo e($bgOption); ?> <?php echo e($backgroundColor); ?>">
  <div class="container">
      ...
      <?php if($col1): ?>
        <div class="columns column1-wrp col-12 col-lg-6 text-center text-md-left <?php echo e($orderClass1); ?>">
          ...
          <div class="intro-content">
            ...
            <?php endif; ?>
            <?php if($col1ButtonPrimary || $col1ButtonSecondary): ?>
              <div class="button-wrapper">
                <?php if($col1ButtonPrimary): ?>
                  <a class="btn btn-primary" href="<?php echo e($col1ButtonPrimary['url']); ?>" target="<?php echo e($col1ButtonPrimary['target']); ?>"><?php echo $col1ButtonPrimary['title'] ?></a>
                <?php endif; ?>
                <?php if($col1ButtonSecondary): ?>
                  <a class="btn btn-secondary" href="<?php echo e($col1ButtonSecondary['url']); ?>" target="<?php echo e($col1ButtonSecondary['target']); ?>"><?php echo $col1ButtonSecondary['title'] ?></a>
                <?php endif; ?>
              </div>
            <?php endif; ?>
          <?php endif; ?>
      ...
      <?php if($col2): ?>
        <div class="columns column2-wrp col-12 col-lg-6 text-center text-md-left <?php echo e($orderClass2); ?>">
          <?php
            ...
            $col2ButtonPrimary = $col2['col2_button_primary'];
            $col2ButtonSecondary = $col2['col2_button_secondary'];
          ?>
          <?php if($col2layout): ?>
            <?php if($col2Image): ?>
              <div class="image-wrapper">
          ...
          <?php endif; ?>
          <?php if($col2ButtonPrimary || $col2ButtonSecondary): ?>
            <div class="button-wrapper">
              <?php if($col2ButtonPrimary): ?>
                <a class="btn btn-primary with-icon" href="<?php echo e($col2ButtonPrimary['url']); ?>" target="<?php echo e($col2ButtonPrimary['target']); ?>"><?php echo $col2ButtonPrimary['title'] ?></a>
              <?php endif; ?>
              <?php if($col2ButtonSecondary): ?>
                <a class="btn btn-secondary with-icon" href="<?php echo e($col2ButtonSecondary['url']); ?>" target="<?php echo e($col2ButtonSecondary['target']); ?>"><?php echo $col2ButtonSecondary['title'] ?></a>
              <?php endif; ?>
            </div>
          <?php endif; ?>
          <?php endif; ?>
